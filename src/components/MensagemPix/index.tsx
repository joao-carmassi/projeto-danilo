...
const MensagemPix = () => {
  ...
  return (
    <div
      id="headerPix"
      className="bg-black hidden lg:block items-center z-10 py-1 text-white duration-200 px-5 w-full"
    >
      <p
        id="textoPix"
        className="w-full italic gap-1 font-semibold flex items-center text-center justify-center text-sm"
      >
        <svg
        ...
        TODA LINHA DE PARTES E PEÇAS PARA VRF |
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="none"
        ...
        PARCELAMENTO EM ATÉ 12 VEZES <span>|</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
